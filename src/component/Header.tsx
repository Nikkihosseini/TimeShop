...
export default function Header(){
    return(
        <>
        <header className="hidden md:flex fixed top-8 right-0 left-0 w-[90%] h-[6rem] z-30 uppercase text-amber-950 bg-amber-200/20 backdrop-blur-md py-2 px-4 mx-auto">
            <div className="flex items-center justify-between w-full">
                ...
                <div className="h-full">
                    <ul className="flex items-center justify-between gap-14 font-semibold h-full tracking-wider">
                       ...
                       <li className="flex items-center relative group hover:text-amber-300 cursor-pointer h-full">
                        home
                        <span className="absolute left-0 bottom-[-7px] h-0.5 bg-amber-400 w-0 group-hover:w-full transition-all ease-in-out duration-300 delay-200"></span>
                       </li>
                       
                       <li className="flex items-center relative group hover:text-amber-300 cursor-pointer h-full">
                        Category
                        <span className="absolute left-0 bottom-[-7px] h-0.5 bg-amber-400 w-0 group-hover:w-full transition-all ease-in-out duration-300 delay-200"></span></li>
